// Type definitions for Tabris.js 3.0.1
 ...
 */
 export class Action extends Widget {
   ...
   * drawer/back button. If multiple actions have this value only the first one is displayed.
   */
 ...
 */
 export class ActionSheet extends Popup {
   ...
   * button was pressed.
   */
  actions: {title: string, image?: ImageValue, style?: 'default'|'cancel'|'destructive'}[];
 ...
 */
 export class App extends NativeObject {
   ...
   * no debugger can be attached to the JavaScript VM.
   * @constant
   */
 ...
 */
 export class CollectionView<Cell extends Widget> extends Composite<Cell> {

  public constructor(properties?: Properties<CollectionView<Cell>> & Partial<Pick<CollectionView<Cell>, 'cellHeight' | 'cellType' | 'createCell' | 'updateCell'>>);
   ...
   */
  cellByItemIndex(itemIndex: number): Cell|null;
   ...
   */
  createCell: (cellType: string) => Cell;
   ...
   * @constant
   */
  readonly jsxAttributes: JSXAttributes<this> & Partial<Pick<CollectionView<Cell>, 'cellHeight' | 'cellType' | 'createCell' | 'updateCell'>> & {children?: never};
   ...
   */
  updateCell: (cell: Cell, index: number) => void;
 ...
 */
 export class ConstraintLayout extends Layout {
  ...
  public constructor(parameterObject?: {});
 ...
 */
 export class Image {
  ...
  /**
   * File system path, relative path or URL. Android and iOS also support [data
   * URI](https://en.wikipedia.org/wiki/Data_URI_scheme). Relative paths are resolved **relative to
   * ‘package.json’**. On Android the name of a bundled [drawable
 ...
 */
 export class Layout {
  ...
  protected constructor(parameterObject: {});
 ...
 */
 export class LinearGradient {
  ...
  public constructor(colorStops: (Color | [Color, Percent])[], direction?: number);
   ...
   * @constant
   */
  readonly colorStops: (Color | [Color, Percent])[];
 ...
 */
 export class NativeObject {
   ...
   */
  protected _nativeCreate(param?: {[prop: string]: any}): void;
   ...
   */
  on(type: string, listener: (event: EventObject<NativeObject>) => void, context?: object): this;
   ...
   * @param context In the listener function, `this` will point to this object. If not present, the listener will be called in the context of this object.
   */
  once(type: string, listener: (event: EventObject<NativeObject>) => void, context?: object): this;
...
/**
 * A composite with the `layout` property initialized with a `Stack`. All children are automatically
 * arranged in one vertical stack, starting from the top. The `layoutData` on the children is ignored.
 */
 ...
 * starting from the top. The `layoutData` on the children is currently ignored.
 */
 export class StackLayout extends Layout {

  public constructor(parameterObject?: {spacing?: number, alignment?: 'left'|'centerX'|'stretchX'|'right'});
 ...
 * layout properties (e.g. either `width` or `left` and `right` must be specified).
 */
 export class TabFolder<ChildType extends Tab = Tab> extends Composite<ChildType> {
 ...
 */
 export class WidgetCollection<T extends Widget = Widget> {
   ...
   * @param items
   */
  concat(...items: Array<T|T[]|WidgetCollection<T>>): WidgetCollection<T>;
   ...
   * @param selector A selector expression or a predicate function to filter the results.
   */
  filter<Result extends T = T>(selector: Selector<T, Result>): WidgetCollection<Result>;
   ...
   * @param selector A selector expression or a predicate function to filter the results.
   */
  first<Result extends T = T>(selector?: Selector<T, Result>): Result|undefined;
   ...
   * @param selector A selector expression or a predicate function to filter the results.
   */
  last<Result extends T = T>(selector?: Selector<T, Result>): Result | undefined;
   ...
   * @param callback The function to call for each widget. The arguments are: *widget*, *index*, *collection*
   */
  map<U>(callback: (widget: T, index: number, collection: WidgetCollection<T>) => U): Array<U>;
   ...
   * @param selector A selector expression or a predicate function to filter the results.
   */
  only<Result extends T = T>(selector?: Selector<T, Result>): Result;
   ...
   * @param properties
   */
  set(properties: Properties<T>): this;
   ...
   */
  slice(start?: number, end?: number): WidgetCollection<T>;
   ...
   * @constant
   */
  readonly jsxAttributes: JSXAttributes<this> & {children?: JSXChildren<T>};
